...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2019/07/04 16:47:31 by kmatulud          #+#    #+#             */
/*   Updated: 2019/07/05 11:50:48 by kmatulud         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */

#include "get_next_line.h"

static int		ft_getnewline(char **str, char **line, int fd, int reader)
{
	char			*temp;
	unsigned int	i;
	unsigned int	length;
